...
3. **Wait for AI review**: Run `python3 $HOME/.codex/plugins/cache/oxidian/oxgl/0.1.5/skills/merge-or-fix/scripts/wait_for_ai_review.py <MR_IID>` (use 45 minute timeout)
