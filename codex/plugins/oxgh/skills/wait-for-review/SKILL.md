...
3. **Wait for AI review**: Run `python3 $HOME/.codex/plugins/cache/oxidian/oxgh/0.1.5/skills/wait-for-review/scripts/wait_for_ai_review.py <PR_NUMBER>` (use 45 minute timeout)
