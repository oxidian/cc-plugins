---
allowed-tools: Bash(python3 ${CLAUDE_PLUGIN_ROOT}/scripts/wait_for_ai_review.py:*), Bash(gh pr view:*), Bash(gh pr checkout:*), Bash(gh pr merge:*), Bash(gh api:*), Bash(git remote get-url origin)
description: Wait for AI code review on a PR — auto-merge if clean, fix issues if not
